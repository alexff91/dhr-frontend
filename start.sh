...
docker run -p 443:443 -p 80:80 -e DOMAINS='vi-hr.com' -v /data/https-portal/vhosts/:/var/www/vhosts --privileged=true --restart=always --name=proxy -d steveltn/https-portal